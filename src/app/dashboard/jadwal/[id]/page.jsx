          ...
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription>
                  ID: {data.id} • Dibuat pada: {formatDateIndonesian(data.created_at)}
                </CardDescription>
              </div>
              <Badge variant="outline" className={`ml-auto ${statusBadgeVariant}`}>
                {data.status}
              </Badge>
            </div>
          </CardHeader>
              ...
              <div className="space-y-6">
                {data.orders.map((order) => {
                  const orderStatusBadgeVariant = {
                    ...
                    completed: "bg-green-100 text-green-800 hover:bg-green-100",
                    cancelled: "bg-red-100 text-red-800 hover:bg-red-100",
                  }[order.status] || "bg-gray-100 text-gray-800 hover:bg-gray-100";
                      ...
                      <div className="p-4 bg-muted/50">
                        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <h3 className="font-medium">{order.customer?.nama}</h3>
                              <p className="text-sm text-muted-foreground">
                          ...
                          <div className="flex items-center gap-3">
                            <Badge variant="outline" className={orderStatusBadgeVariant}>
                              {order.status}
                            </Badge>
                        ...
                        <Table>
                          <TableHeader>
                            <TableRow>
                              ...
                              <TableHead className="text-right">Dimensi</TableHead>
                            </TableRow>
                          </TableHeader>
                          <TableBody>
                            {order.order_detail.map((detail) => (
                              <TableRow key={detail.id}>
                                ...
                                <TableCell className="text-right">
                                  {detail.produk?.panjang}m × {detail.produk?.lebar}m ×{" "}
